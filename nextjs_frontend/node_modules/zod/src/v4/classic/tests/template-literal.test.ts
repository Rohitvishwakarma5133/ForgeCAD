...
test("template literal parsing - success - complex cases", () => {
  ...
  connectionString.parse("{{REDACTED_MONGODB_URI}}");
  connectionString.parse("{{REDACTED_MONGODB_URI}}");
  connectionString.parse("{{REDACTED_MONGODB_URI}}");
  connectionString.parse("{{REDACTED_MONGODB_URI}}");
  connectionString.parse("{{REDACTED_MONGODB_URI}}");
...
test("template literal parsing - failure - complex cases", () => {
  ...
  expect(() => connectionString.parse("{{REDACTED_MONGODB_URI}}")).toThrow();
  expect(() => connectionString.parse("{{REDACTED_MONGODB_URI}}")).toThrow();
  expect(() => connectionString.parse("{{REDACTED_MONGODB_URI}}")).toThrow();
  expect(() => connectionString.parse("{{REDACTED_MONGODB_URI}}")).toThrow();
...
test("template literal parsing - failure - issue format", () => {
  ...
  `);
  expect(connectionString.safeParse("{{REDACTED_MONGODB_URI}}")).toMatchInlineSnapshot(`
    {
      "error": [ZodError: [
      {
        "code": "invalid_format",
