...
exports.testPerfectExtraction = testPerfectExtraction;
exports.testCriticalMissing = testCriticalMissing;
exports.testMultiScaleAnalysis = testMultiScaleAnalysis;
exports.testFalsePositiveDetection = testFalsePositiveDetection;
exports.testReportGeneration = testReportGeneration;
exports.runBenchmarkTest = runBenchmarkTest;
exports.createSampleDWGEntities = createSampleDWGEntities;
exports.createPerfectExtractionEntities = createPerfectExtractionEntities;
exports.createCriticalMissingEntities = createCriticalMissingEntities;
exports.createLowConfidenceEntities = createLowConfidenceEntities;
exports.createMultiScaleTestEntities = createMultiScaleTestEntities;
const critical_missing_detector_1 = __importDefault(require("../lib/validation/critical-missing-detector"));
// Test data generators
function createSampleDWGEntities() {
    return [
...
function createPerfectExtractionEntities() {
...
function createCriticalMissingEntities() {
...
function createLowConfidenceEntities() {
...
function createMultiScaleTestEntities() {
...
async function testPerfectExtraction() {
    ...
    const result = await critical_missing_detector_1.default.detectMissingEquipment(dwgEntities, extractedEntities);
    ...
    const acceptancePassed = result.missingRate <= 0.01 &&
...
async function testReportGeneration() {
    ...
    const result = await critical_missing_detector_1.default.detectMissingEquipment(dwgEntities, extractedEntities);
    const detailedReport = critical_missing_detector_1.default.exportDetailedReport(result);
...
async function runBenchmarkTest() {
    ...
    const largeDwgEntities = [];
    const largeExtractedEntities = [];
    for (let i = 0; i < 1000; i++) {
        ...
        if (i % 20 !== 0) {
            largeExtractedEntities.push({
                ...
                source: ['ocr_100', 'ocr_200', 'ocr_400'][i % 3],
    ...
    const result = await critical_missing_detector_1.default.detectMissingEquipment(largeDwgEntities, largeExtractedEntities);
...
async function runAllTests() {
    ...
    try {
        ...
        const perfectTest = testResults[0];
        const criticalTest = testResults[1];
        const multiScaleTest = testResults[2];
        const reportTest = testResults[4];
        const benchmarkTest = testResults[5];
        const allTestsPassed = perfectTest.acceptancePassed &&
