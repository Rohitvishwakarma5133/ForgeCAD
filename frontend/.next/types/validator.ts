...
// Validate ../../app/api/health/mongodb/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/health/mongodb">> = Specific
  const handler = {} as typeof import("../../app/api/health/mongodb/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../app/api/status/stream/[id]/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/status/stream/[id]">> = Specific
  const handler = {} as typeof import("../../app/api/status/stream/[id]/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
